...
def train_genus(
    ...
    validation_prompt = f"a street-level Google Street View photograph of a tree, genus {genus}, urban environment"
...
def main():
    ...
    model_cache = os.environ.get("MODEL_CACHE", "/share/rkmeente/btfarre2/model/model_cache")
